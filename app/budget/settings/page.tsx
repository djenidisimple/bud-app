        ...
        <div className="p-6">
          ...
          {loading ? (
            <div className="flex items-center justify-center py-10">
              <Loader2 className="animate-spin h-6 w-6 text-[#4f5bd5]" />
            </div>
          ) : users.length === 0 ? (
                      ...
                      <td className="py-4 px-2 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="p-2 rounded-lg hover:bg-gray-100 text-[#6b7078] hover:text-[#4f5bd5] transition-all"
                            title="Modifier"
                          >
        ...
        <DialogContent>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex items-center gap-2 justify-end pt-2">
              ...
              <Button onClick={handleSaveEdit} disabled={saving} className="bg-[#4f5bd5] text-white font-bold hover:bg-[#3f4bb5] text-sm">
