...
export default function Logic({ params }: { params: Promise<{ projectId: string }> }) {
    ...
    const showData = async () => {
        if (!projectId) {
            toast.error("Projet non chargé !");
            return;
        }
        await axiosInstance.post('/api/postData', {
            ...dataAll
        }, {
            params: {
                projectId: projectId
                    ...
                    <div className="flex flex-1 justify-between items-center max-w-6xl mx-auto">
                        ...
                        <div className="flex items-center">
                            <div className="mr-3 bg-blue-100 p-2 rounded-full">
                                <Tooltip>
                                    ...
                                    <TooltipContent className="bg-white rounded-md shadow-lg border border-gray-200 p-4 min-w-[280px]">
                                        ...
                                        <ul className="space-y-2 max-h-60 overflow-y-auto pr-2">
                                            ...
                                            >
                                                ...
                                                {editMoney(Number(res.prix) || 0, ',')} Ar
                                                </span>
                                            </li>
                                            ))}
                                        </ul>
                                    ...
                                    <TooltipContent className="bg-white rounded-md shadow-lg border border-gray-200 p-4 min-w-[280px]">
                                        ...
                                        <ul className="space-y-2 max-h-60 overflow-y-auto pr-2">
                                            ...
                                            >
                                                ...
                                                <span className="bg-blue-50 text-red-700 font-medium px-2 py-1 rounded-md text-sm">
                                    ...
                                    <TooltipContent className="bg-white rounded-md shadow-lg border border-gray-200 p-4 min-w-[280px]">
                                        ...
                                        <ul className="space-y-2 max-h-60 overflow-y-auto pr-2">
                                            ...
                                            >
                                                ...
                                                <span className="bg-blue-50 text-green-700 font-medium px-2 py-1 rounded-md text-sm">
                        ...
                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div 
                                ...
                                style={{ 
                                    width: `${totalResource > 0 ? Math.min((totalSpend / totalResource) * 100, 100) : 0}%` 
                                }}
                            />
                        </div>
