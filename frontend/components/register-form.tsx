            ...
            <div className="grid gap-3">
              ...
              <div className="relative">
                  <div 
                    ...
                    focus-within:shadow-[0_0_0_4px_rgba(99,102,241,0.15)] 
                  ...
                  <div 
                    ...
                    {[1, 2, 3, 4].map((level) => (
                      <div 
                        key={level} 
                        className={`h-1 rounded-full ${passwordStrength >= level ? 
                    ...
                    {passwordStrength > 0 && (
                        ...
                        {["Faible", "Moyen", "Fort", "Très fort"][passwordStrength - 1]}
                        </div>
                    )}
                  </div>
                </div>
